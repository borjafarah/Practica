...
ax6.plot(base_efec08['medicion'], var_diurna08 + pd.Series.mean(base_efec08['valor']), '.')
ax6.plot(base_efec08['medicion'], basecont(base_efec08['medicion'], int_diurna08) + pd.Series.mean(base_efec08['valor']))
ax6.plot(base_efec08['medicion'], var_diurna08 + pd.Series.mean(base_efec08['valor']), '.')
